...
public class UploadDownloadTest {
    ...
    public void checkUploadData() throws InterruptedException, IOException {
     ...
     String fruit="Apple";
        ...
        String newPrice=driver.findElement(By.xpath("//div[text()='"+fruit+"']/../../div[@id='cell-"+colNumber+"-undefined']/div")).getText();

        System.out.println(newPrice);

        File file=new File("C:\\Users\\VaVe\\Downloads\\download.xlsx");
        file.delete();
